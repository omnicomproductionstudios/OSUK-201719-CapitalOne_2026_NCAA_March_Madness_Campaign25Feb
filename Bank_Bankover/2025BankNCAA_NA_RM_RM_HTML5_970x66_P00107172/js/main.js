...
function init(){ 
  ...
  mainTL.from('.capOneLogo', 0.4,{x:"-=232", ease:'power1.out', overwrite:0}, 0.25)
        ...
        .to('.ballCont #ball', 0.2,{y:"+=22", ease: "power1.in", yoyo:true, repeat:20}, _f1+0.5)  
...
function expand(){
    ...
    expandedTL.to(banner, 0,{css:{overflow:"visible"}}, 0)
              ...
              .from('.ballContExp #ball2', 2,{x:"-=580", rotation:"-=850", ease: "none"}, _f1+0.5)
              .from('.ballContExp #ball2Shadow', 2,{x:"-=580", ease: "none"}, _f1+0.5)
              .from('.ncaaLockupCont', 2,{x:"-=530", ease: "none"}, _f1+0.5)
              .from(proudPartnerOf, 2,{x:"+=530", ease: "none"}, _f1+0.5)
              // .from(ncaammLogo, 2,{x:"+=530", ease: "none"}, _f1+0.5)
