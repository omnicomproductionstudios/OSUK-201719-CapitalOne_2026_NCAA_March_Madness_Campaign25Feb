...
function init(){ 
  ...
  mainTL.from('.capOneLogo', 0.4,{x:"-=232", ease:'power1.out', overwrite:0}, 0.25)
        ...
        .from('.ballCont', 3,{x:"-=1340", ease: "none"}, _f1+0.5)  
        .to('.ballCont #ball', 0.2,{y:"+=28", ease: "power1.in", yoyo:true, repeat:20}, _f1+0.5)  
        .to('.ballCont #ballShadow', 0.2,{alpha:1, scaleX:2, transformOrigin:"50% 50%", ease: "power1.in", yoyo:true, repeat:20}, _f1+0.5)  
        .from('.ballCont #ball', 3,{rotation:"-=1340", ease: "none"}, _f1+0.5)  
        .from(txt1Cont, 2.95,{x:"-=1270", ease:'none'}, _f1+0.55)
        .from(txt1a, 2.95,{x:"+=1270", ease:'none'}, _f1+0.55)
}
...
function expand(){
    ...
    expandedTL.to(banner, 0,{css:{overflow:"visible"}}, 0)
              ...
              // .from(txt2d, 0.5,{alpha:0, x:"+=25", ease:'power2.easeInOut', overwrite:0}, '<+=0.05')
              ...
              .from('.ballContExp #ball2', 2,{x:"-=650", rotation:"-=650", ease: "none"}, _f1+0.5)
              .from('.ballContExp #ball2Shadow', 2,{x:"-=650", ease: "none"}, _f1+0.5)
              .from('.ncaaLockupCont', 2,{x:"-=546", ease: "none"}, _f1+0.6)
              .from(proudPartnerOf, 2,{x:"+=546", ease: "none"}, _f1+0.6)
              .from(ncaammLogo, 2,{x:"+=546", ease: "none"}, _f1+0.6)
